      ...
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.png" max-height="100%" max-width="100%" contain>
              ...
              <v-card-text class="ml-10">
                <h3 class="green--text">#Free Delievry</h3>
              </v-card-text>
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
          ...
          <v-card
            flat
            color="#E2F2E5"
            class="rounded-xl mtop mbottom mx-10 px-4"
            height="350"
          >
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                ...
                <p>
                  ...
                  Illum laboriosam, consequatur quia corrupti neque magnam
                  amet<br />
                  repellendus mollitia cumque impedit provident corporis nemo<br />
                  perferendis incidunt praesentium et sit assumenda minima?
                </p>
